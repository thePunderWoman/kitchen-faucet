...
export function renderApplication(rootComponent, options) {
    ...
    const appProviders = [
        ...
        // FIXME: this line must be removed, this effectively duplicates
