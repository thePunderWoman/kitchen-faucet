...
export declare function ɵdisableSsrPeformanceProfiler(): void;

export declare function ɵenableSsrPeformanceProfiler(profiler?: ɵSsrProfiler): void;
...
export declare function ɵgetSsrProfiler(): ɵSsrProfiler | null;
...
export declare function ɵisSsrProfilerEnabled(): boolean;
...
export declare const enum ɵSsrPerfMetrics {
    /**
 ...
 */
export declare class ɵSsrProfiler {
    private metrics;
    private initTimespanMetric;
    invokeAndMeasure<T>(functionToProfile: () => T, metric: ɵSsrPerfMetrics): T;
    startTimespan(metric: ɵSsrPerfMetrics): void;
    stopTimespan(metric: ɵSsrPerfMetrics): void;
    incrementMetricValue(metric: ɵSsrPerfMetrics, value: number): void;
    serializeMetrics(): string;
    getMetric(metric: ɵSsrPerfMetrics): number;
}
