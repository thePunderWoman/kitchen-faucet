 ...
 *
 */
export function getComponentId(componentDef) {
    let hash = 0;
    const hashSelectors = [
        ...
        componentDef.styles?.reduce((prev, current) => current.length + prev, 0),
