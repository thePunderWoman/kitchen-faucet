 ...
 * @publicApi
 */
export declare function hydrateApplication<T>(rootComponent: Type<T>, options?: {
    providers: Provider[];
}): Promise<ApplicationRef>;

export declare class HydrationRendererFactory2 implements RendererFactory2 {
    private document;
    private state;
    private config;
    private delegateRendererFactory2;
    constructor();
    createRenderer(element: any, type: RendererType2 | null): Renderer2;
    begin(): void;
    end(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<HydrationRendererFactory2, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<HydrationRendererFactory2>;
}
