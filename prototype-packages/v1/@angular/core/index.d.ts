...
import { Renderer2 as Renderer2_2 } from '@angular/core';
import { RendererStyleFlags2 as RendererStyleFlags2_2 } from '@angular/core';
...
declare abstract class ComponentFactory<C> {
     ...
     */
    abstract create(injector: Injector, projectableNodes?: any[][], rootSelectorOrNode?: string | any, environmentInjector?: EnvironmentInjector | NgModuleRef<any>, hydrationKey?: string): ComponentRef<C>;
}
 ...
 */
export declare const DELEGATE_RENDERER_FACTORY_FN: InjectionToken<(delegate: RendererFactory2) => RendererFactory2>;
...
declare const HYDRATION_KEY = 22;
 ...
 */
export declare class HydrationRenderer {
    private document;
    private state;
    private config;
    private delegate;
     ...
     */
    private debug;
    constructor(document: any, state: ɵHydrationState, config: ɵHydrationConfig, delegate: Renderer2_2);
    destroy(): void;
    ...
    setStyle(el: any, style: string, value: any, flags: RendererStyleFlags2_2): void;
    removeStyle(el: any, style: string, flags: RendererStyleFlags2_2): void;
...
declare interface LView<T = unknown> extends Array<any> {
    ...
    /**
     * Unique identifier for this LView in a context of hydration.
     */
...
export declare abstract class TemplateRef<C> {
     ...
     */
    abstract createEmbeddedView(context: C, injector?: Injector, hydrationKey?: string): EmbeddedViewRef<C>;
}
 ...
 */
export declare function ɵannotateForHydration(doc: Document, element: Element, enableKeyCompression: boolean): void;
...
export declare interface ɵHydrationConfig {
 ...
 */
export declare interface ɵHydrationState {
    inDeoptMode: boolean;
...
export declare class ɵRender3ComponentFactory<T> extends ComponentFactory<T> {
    ...
    create(injector: Injector, projectableNodes?: any[][] | undefined, rootSelectorOrNode?: any, environmentInjector?: NgModuleRef<any> | EnvironmentInjector | undefined, hydrationKey?: string): ComponentRef<T>;
}
