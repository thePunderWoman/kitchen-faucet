...
export class ApplicationRef {
    ...
    bootstrap(componentOrFactory, rootSelectorOrNode) {
        ...
        const compRef = componentFactory.create(Injector.NULL, [], selectorOrNode, ngModule, hydrationKey);
