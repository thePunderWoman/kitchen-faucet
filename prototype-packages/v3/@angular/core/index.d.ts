...
declare const HYDRATION_INFO = 22;
 ...
 */
declare type LocalRefExtractor = (tNode: TNodeWithLocalRefs, currentView: ɵLView) => any;
...
declare interface LQueries {
     ...
     * @param tView
     */
    createEmbeddedView(tView: ɵTView): LQueries | null;
    /**
...
declare interface NghView extends NghDom {
    template: string;
    numRootNodes: number;
    firstChild: HTMLElement;
}
...
declare interface RComment extends ɵRNode {
 ...
 */
declare interface RElement extends ɵRNode {
...
declare interface Renderer {
     ...
     */
    destroyNode?: ((node: ɵRNode) => void) | null;
    appendChild(parent: RElement, newChild: ɵRNode): void;
    insertBefore(parent: ɵRNode, newChild: ɵRNode, refChild: ɵRNode | null, isMove?: boolean): void;
    removeChild(parent: RElement, oldChild: ɵRNode, isHostElement?: boolean): void;
    selectRootElement(selectorOrNode: string | any, preserveContent?: boolean): RElement;
    parentNode(node: ɵRNode): RElement | null;
    nextSibling(node: ɵRNode): ɵRNode | null;
    ...
    listen(target: GlobalTargetName | ɵRNode, eventName: string, callback: (event: any) => boolean | void): () => void;
}
...
declare interface RText extends ɵRNode {
    textContent: string | null;
}
 ...
 */
declare type TData = (ɵTNode | ɵPipeDef<any> | ɵDirectiveDef<any> | ɵComponentDef<any> | number | TStylingRange | TStylingKey | ProviderToken<any> | TI18n | I18nUpdateOpCodes | TIcu | null | string)[];

/** Static data for an <ng-container> */
declare interface TElementContainerNode extends ɵTNode {
    /** Index in the LView[] array. */
    index: number;
    child: TElementNode | TTextNode | ɵTContainerNode | TElementContainerNode | TProjectionNode | null;
...
declare interface TElementNode extends ɵTNode {
    /** Index in the data[] array */
    index: number;
    child: TElementNode | TTextNode | TElementContainerNode | ɵTContainerNode | TProjectionNode | null;
    /**
 ...
 */
declare type TNodeWithLocalRefs = ɵTContainerNode | TElementNode | TElementContainerNode;

/** Static data for an LProjectionNode  */
declare interface TProjectionNode extends ɵTNode {
    /** Index in the data[] array */
    child: null;
    /**
...
declare interface TQueries {
     ...
     * @param tNode
     */
    elementStart(tView: ɵTView, tNode: ɵTNode): void;
    /**
     * A proxy method that iterates over all the TQueries in a given TView and calls the corresponding
     * `elementEnd` on each and every TQuery.
     * @param tNode
     */
    elementEnd(tNode: ɵTNode): void;
    /**
     * A proxy method that iterates over all the TQueries in a given TView and calls the corresponding
     ...
     * @param tNode
     */
    template(tView: ɵTView, tNode: ɵTNode): void;
    /**
     * A proxy method that iterates over all the TQueries in a given TView and calls the corresponding
     * `embeddedTView` on each and every TQuery.
     * @param tNode
     */
    embeddedTView(tNode: ɵTNode): TQueries | null;
}
...
declare interface TQuery {
     ...
     */
    embeddedTView(tNode: ɵTNode, childQueryIndex: number): TQuery | null;
}
...
declare interface TTextNode extends ɵTNode {
    /** Index in the data[] array */
    index: number;
    child: null;
    /**
...
export declare function ɵcollectNativeNodes(tView: ɵTView, lView: ɵLView, tNode: ɵTNode | null, result: any[], isProjection?: boolean): any[];
...
export declare const ɵCONTEXT = 8;
...
export declare function ɵgetLViewById(id: number): ɵLView | null;
 ...
 */
export declare const ɵHEADER_OFFSET = 23;

export declare const ɵHOST = 0;
...
export declare function ɵisRootView(target: ɵLView): boolean;
 ...
 * of type.
 */
export declare interface ɵLContainer extends Array<any> {
    /**
     ...
     */
    readonly [ɵHOST]: RElement | RComment | ɵLView;
    /**
 ...
 */
export declare interface ɵLView<T = unknown> extends Array<any> {
    /**
     ...
     */
    [PARENT]: ɵLView | ɵLContainer | null;
    /**
     *
     ...
     */
    [CHILD_HEAD]: ɵLView | ɵLContainer | null;
    /**
     ...
     */
    [CHILD_TAIL]: ɵLView | ɵLContainer | null;
    /**
     ...
     */
    [DECLARATION_COMPONENT_VIEW]: ɵLView;
    /**
     ...
     */
    [DECLARATION_LCONTAINER]: ɵLContainer | null;
    /**
...
export declare class ɵRender3ComponentRef<T> extends ComponentRef<T> {
    ...
    constructor(componentType: Type<T>, instance: T, location: ElementRef, _rootLView: ɵLView, _tNode: TElementNode | ɵTContainerNode | TElementContainerNode);
...
export declare interface ɵRNode {
    /**
     * Returns the parent Element, Document, or DocumentFragment
     */
    parentNode: ɵRNode | null;
    /**
     ...
     */
    nextSibling: ɵRNode | null;
    /**
     * Removes a child from the current node and returns the removed node
     * @param oldChild the child node to remove
     */
    removeChild(oldChild: ɵRNode): ɵRNode;
    /**
     * Insert a child node.
     *
     * Used exclusively for adding View root nodes into ViewAnchor location.
     */
    insertBefore(newChild: ɵRNode, refChild: ɵRNode | null, isViewRoot: boolean): void;
    /**
     * Append a child node.
     *
     * Used exclusively for building up DOM which are static (ie not View roots)
     */
    appendChild(newChild: ɵRNode): ɵRNode;
}
...
export declare function ɵstore<T>(tView: ɵTView, lView: ɵLView, index: number, value: T): void;


export declare function ɵstringify(token: any): string;

/** Static data for an LContainer */
export declare interface ɵTContainerNode extends ɵTNode {
    /**
     * Index in the data[] array.
     *
 ...
 */
export declare interface ɵTNode {
     ...
     */
    parent: TElementNode | ɵTContainerNode | null;
    /**
     ...
     */
    projection: (ɵTNode | ɵRNode[])[] | number | null;
    /**
 ...
 */
export declare const enum ɵTNodeType {
    /**
 ...
 */
export declare interface ɵTView {
    /**
 ...
 */
export declare const enum ɵTViewType {
    /**
 ...
 */
export declare function ɵunwrapRNode(value: ɵRNode | ɵLView | ɵLContainer): ɵRNode;
...
export declare class ɵViewRef<T> implements EmbeddedViewRef<T>, InternalViewRef, viewEngine_ChangeDetectorRef_interface {
     ...
     * This may be different from `_lView` if the `_cdRefInjectingView` is an embedded view.
     */
    _cdRefInjectingView?: ɵLView<unknown> | undefined);
    get context(): T;
    set context(value: T);
    get destroyed(): boolean;
    destroy(): void;
 ...
 * @developerPreview
 */
export declare function ɵwithHydrationSupport(): {
 ...
 * @codeGenApi
 */
export declare function ɵɵtemplateRefExtractor(tNode: ɵTNode, lView: ɵLView): TemplateRef<any> | null;
