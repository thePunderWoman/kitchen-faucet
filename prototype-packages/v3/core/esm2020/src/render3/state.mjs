...
export function isInNonHydratableBlock() {
    return instructionState.nonHydratableRootTNode !== null;
}
export function isNonHydratableRootTNode(tNode) {
...
// TODO: Add Comments
export function enterNonHydrableBlock(tNode) {
...
// TODO: Add Comments
export function leaveNonHydratableBlock() {
