...
load("//@angular/bazel/src/ng_module:partial_compilation.bzl", "partial_compilation_transition")
load("//@angular/bazel/src/types_bundle:index.bzl", "bundle_type_declaration")
...
_NG_PACKAGE_ATTRS = dict(PKG_NPM_ATTRS, **{
    ...
    "license_banner": attr.label(
        ...
        the special version `15.1.0-next.2+sha-aab62c7-with-local-changes`. See the section on stamping in the README.""",
    ...
    "_types_bundler_bin": attr.label(
        default = "@npm//@angular/bazel/bin:types_bundler",
        cfg = "exec",
        executable = True,
    ),
